...
// Disco
    ...
    public Integer obterFkMaquinaNuvem(String nomeMaquina, Integer fkEmpresa) {
        ConexaoNuvem conexaoNuvem = new ConexaoNuvem();
        JdbcTemplate conNuvem = conexaoNuvem.getConexaoDoBanco();

        String sqlNuvem = "SELECT TOP 1 idMaquina FROM maquina LEFT JOIN empresa ON idempresa = fkEmpresa WHERE hostName = ? AND fkEmpresa = ?";

        try {
            Integer valorNuvem = conNuvem.queryForObject(sqlNuvem, Integer.class, nomeMaquina, fkEmpresa);
            return valorNuvem;
    ...
    public Map<String, Integer> obterFksTipoComponenteNuvem(){
        ...
        List<Map<String, Object>> results = con.queryForList(
                "  WITH CTE AS (\n" +
                        ...
                        "    FROM TipoComponente\n" +
                        "    WHERE nomeTipo IN ('Memoria Usada', 'Memoria em Uso', 'Memoria Disponível', 'Percentual de uso do Disco', 'Tamanho do Disco', 'Tamanho Disponível', 'Percentual de Uso do Processador', 'Bytes Recebidos', 'Bytes Enviados', 'Percentual de Memoria' , 'Pacotes Enviados' , 'Pacotes Recebidos')\n" +
                        ")\n" +
        ...
        if (!results.isEmpty()) {
            Integer FkMemoriaUsada = null, fkMemoriaEmUso = null, fkMemoriaDisponivel = null, fkPercentualDisco = null,
                    ...
                    fkPacotesRecebidos = null , fkPacotesEnviados = null;
            ...
            for (Map<String, Object> coluna : results) {
                ...
                switch (nomeTipo) {
                    ...
                    case "Percentual de Memoria":
                        ...
                        break;
                    case "Pacotes Recebidos":
                        fkPacotesRecebidos = idTipoComponente;
                        break;
                    case "Pacotes Enviados":
                        fkPacotesEnviados = idTipoComponente;
                        break;
                    default:
            ...
            valoresFk.put("fkPacotesRecebidos", fkPacotesRecebidos);
            valoresFk.put("fkPacotesEnviados", fkPacotesEnviados);
    ...
    public void inserirMedicoesNuvem(Memoria memoria , Rede rede , Processador processador, Disco disco, Integer fk_computador,
                                     Integer FkMemoriaUsada, Integer fkmemoriaUso , Integer fkMemoriaDipsonivel , Integer fkpercetDisco ,
                                     Integer fktamanhoDisco , Integer fkTamanhoDisponivelDisco , Integer fkpercentualProcessador,
                                     Integer fkBytesRecebidos , Integer fkBytesEnviados, Integer fkUnidadeMedida,  Integer fkmediaMemoria,  Integer fkPacotesRecebidos , Integer fkPacotesEnivados){
        ConexaoNuvem conexaoNuvem = new ConexaoNuvem();
        JdbcTemplate conNuvem = conexaoNuvem.getConexaoDoBanco();
        Date dataHoraAtual = new Date();
        ...
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", memoria.getMemoria_Disponivel(),dataHoraAtual, fk_computador, fkMemoriaDipsonivel , 1);
//
        // nuvem

        // inserção de cpu
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", processador.getPercentual_uso_do_processador(),dataHoraAtual, fk_computador, fkpercentualProcessador , 1);

        // inserção de disco
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", disco.getPorcentagem_de_Uso_do_Disco(),dataHoraAtual, fk_computador, fkpercetDisco , 1);
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", disco.getTamanho_Total_do_Disco(),dataHoraAtual, fk_computador, fktamanhoDisco, 1);
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", disco.getTamanho_disponivel_do_disco(),dataHoraAtual, fk_computador, fkTamanhoDisponivelDisco , 1);


        // inserção de  Memoria

       conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", memoria.getMemoria_total(),dataHoraAtual, fk_computador,FkMemoriaUsada , 1);
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", memoria.getMemoria_em_uso(),dataHoraAtual, fk_computador, fkmemoriaUso , 1);
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", percentualDeUsoMemoria,dataHoraAtual, fk_computador, fkmediaMemoria , 1);

        // inserção de rede

        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", rede.getQuantidade_bytes_enviados(),dataHoraAtual, fk_computador, fkBytesEnviados , 1);
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", rede.getQuantidade_bytes_recebidos(),dataHoraAtual, fk_computador, fkBytesRecebidos , 1);

        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", rede.getQuantidade_pacotes_enviados(),dataHoraAtual, fk_computador, fkPacotesEnivados , 1);
        conNuvem.update("insert into Medicoes (valor, data_hora_leitura, id_computador, fkTipoComponenteID, fkUnidadeMedidaID) values (? ,?, ? , ? , ?)", rede.getQuantidade_pacotes_recebidos(),dataHoraAtual, fk_computador, fkPacotesRecebidos , 1);
    ...
    public void Alertas(Memoria memoria,Disco disco,Rede rede,Processador processador, Integer fk_computador, Integer fkUnidade,
        ...
        if (percentualDeUso >= limiteCritico) {
            con.update("INSERT INTO MetricasAlertas " +
                    ...
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteM, maximoMemoria, mensagemMemoriaCritico, minimoMemoria, dataHoraAtual, 1, fkMemoriaDipsonivel, fkConfigMemoriaDisponivel);
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteM, maximoMemoria, mensagemMemoriaCritico, minimoMemoria, dataHoraAtual, 1, fkmemoriaUso, fkmemoriaUso);
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteM, maximoMemoria, mensagemMemoriaCritico, minimoMemoria, dataHoraAtual, 1, FkMemoriaUsada, fkConfigMemoriaUsada);
            //CHAMANDO LOG
        ...
        if(disco.getPorcentagem_de_Uso_do_Disco() >=limiteCritico){
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoCritico, minimoMemoria, dataHoraAtual, fkUnidade, 1, fkConfigPercentDisco, fkConfigPercentDisco);
            log(tipoComponenteD , disco.getPorcentagem_de_Uso_do_Disco()  , mensagemDiscoCritico);
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoCritico, minimoMemoria, dataHoraAtual, 1, fkConfigPercentDisco, fkConfigPercentDisco);
            log(tipoComponenteD , disco.getPorcentagem_de_Uso_do_Disco()  , mensagemDiscoCritico);
        }
            ...
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoAlerta, minimoMemoria, dataHoraAtual, 1, fkUnidade, fkConfigPercentDisco, fkConfigPercentDisco);
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoAlerta, minimoMemoria, dataHoraAtual, 1, fkUnidade, fkConfigPercentDisco, fkConfigPercentDisco);
        ...
        if(mediaDeRede < limiteInferiorRede){
            ...
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteR, maximoMemoria, mensagemCriticoRede, minimoMemoria, dataHoraAtual, 1, fkBytesRecebidos,fkConfigBytesRecebidos);
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteR, maximoMemoria, mensagemCriticoRede, minimoMemoria, dataHoraAtual, 1, fkBytesEnviados,fkConfigBytesEnviados);
            //CHAMANDO LOG
            Logger.getGlobal().info(String.format("[%s] Tipo: %s, Percentual de Uso: %.2f%% - %s", dataHoraAtual, tipoComponenteR, mediaDeRede, mensagemCriticoRede));
        }
        ...
        if(processador.getPercentual_uso_do_processador() >= limiteAlerta){
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteP, maximoMemoria, mensagemAlertaProcessador, minimoMemoria, dataHoraAtual , 1, fkpercentualProcessador, fkconfigPercentualProcessador);
        }
        else if(processador.getPercentual_uso_do_processador() >= limiteCritico){
            con.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteP, maximoMemoria, mensagemAlertaCriticoProcessador, minimoMemoria, dataHoraAtual, 1, fkpercentualProcessador, fkconfigPercentualProcessador);
        }
    }
    public void AlertasNuvem(Memoria memoria,Disco disco,Rede rede,Processador processador, Integer fk_computador, Integer fkUnidade,
        ...
        if(disco.getPorcentagem_de_Uso_do_Disco() >=limiteCritico){
            conNuvem.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoCritico, minimoMemoria, dataHoraAtual, 1, fkUnidade, fkConfigPercentDisco, fkConfigPercentDisco);
            conNuvem.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoCritico, minimoMemoria, dataHoraAtual, 1, fkConfigPercentDisco, fkConfigPercentDisco);
            ...
            conNuvem.update("INSERT INTO MetricasAlertas " +
                    "(TipoComponente, maximo, mensagemAlerta, minimo, dhHoraAlerta, fkUnidadeMedida, fkTipoComponente, fkConfiguracao) " +
                    "VALUES " +
                    "(?, ?, ?, ?, ?, ?, ?, ?);", tipoComponenteD, maximoMemoria, mensagemDiscoAlerta, minimoMemoria, dataHoraAtual, 1, fkConfigPercentDisco, fkConfigPercentDisco);
        }
        // alerta de rede
        if(mediaDeRede < limiteInferiorRede){
            conNuvem.update("INSERT INTO MetricasAlertas " +
