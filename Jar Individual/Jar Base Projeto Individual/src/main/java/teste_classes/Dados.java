...
public class Dados {
    public static void main(String[] args) {
        ...
        if(resultado_select_cliente == 200) {
            ...
            boolean insercaoRealizada = false;

            if(resultado == null){
              Integer fkEndereco = insert.buscarFkEnderecoNuvem(cliente);
                System.out.println("Vimos que vc não tem cadastro de instituição vamos ao cadastro pra inserir suas maquinas");
                System.out.println("Digite o nome da Intituição");
                String nomeInstituicao = leitor.nextLine();
                insert.inserirDadosUnidadeNuvem(nomeInstituicao ,fkEndereco);
                insercaoRealizada = true;
            }
...
//                        insertMaquina.atualizarFkUnidadeMedida(fk_maquina);
                        ...
                        System.out.println("fk maquina nuvem " + fk_maquinaNuvem);
...
//                            fkBytesRecebidos , fkBytesEnviados);
                        ...
                        System.out.println(fkMemoriaUsadaNuvem);
                        System.out.println(fkMemoriaEmUsoNuvem);
                        System.out.println(fkMemoriaDipsonivelNuvem);
                        System.out.println(fkpercetDiscoNuvem);
                        System.out.println(fktamanhoDiscoNuvem);
                        System.out.println(fkTamanhoDisponivelDiscoNuvem);
                        System.out.println(fkpercentualProcessadorNuvem);
                        System.out.println(fkBytesRecebidosNuvem);
                        System.out.println(fkBytesEnviadosNuvem);
                        System.out.println(fkMemoriaDipsonivelNuvem);
                        System.out.println(fkpacotesenviadosNuvem);
                        System.out.println(fkpacotesrecebidosNuvem);
...
//                    Integer fkConfigBytesEnviados = configuracoes.get("ConfiguracaoBytesEnviados");
                        ...
                        Integer fkMaquinaNuvem = insertMaquina.obterFkMaquinaNuvem(maquina01.getNomeMaquina(), idEmpresaNuvem);
...
//                    );
                        ...
                        insertMaquina.AlertasNuvem(
                                dados_memoria, disco01, rede, processador, fkMaquinaNuvem, fkUnidadeNuvem, fkMemoriaUsadaNuvem, fkMemoriaEmUsoNuvem,
                                fkMemoriaDipsonivelNuvem, fkpercetDiscoNuvem, fktamanhoDiscoNuvem, fkTamanhoDisponivelDiscoNuvem, fkpercentualProcessadorNuvem,
